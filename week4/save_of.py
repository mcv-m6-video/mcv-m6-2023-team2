...
def __parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--cameras', required=True, help='List of cameras to process, e.g. "c010,c011,c012,c013,c014,c015"',
                        type=lambda s: [item for item in s.split(',')])
    parser.add_argument('--max_frames', type=int, required=True, help='Maximum number of frames to process')
